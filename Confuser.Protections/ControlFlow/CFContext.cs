			...
			if (!Method.Module.IsClr40 && JunkCode &&
				...
				switch (Random.NextInt32(3)) {
					case 0:
                        ...
                        */
                        instrs.Add(Instruction.Create(OpCodes.Cpblk));
                        instrs.Add(Instruction.Create(OpCodes.Ldelem_R4, instrs[0]));
                        instrs.Add(Instruction.Create(OpCodes.Blt));
                        instrs.Add(Instruction.Create(OpCodes.Ble_Un_S, instrs[1]));
                        break;
